...
valfri sträng eller siffra. Därefter används router.nagivateByUrl('url') i stället för router.navigate('page'). Url här är den specifika platsen på målsidan där datan kommmer
...
2) App-routing.module: I routes:

 {
        ...
        resolve: {ID: DataResolverService}, [Byt ID mot namnet på den data som ska skickas, exempelvis activity. Detta är slutet av url:en som sedan används, ex. home/activity]
